...
int main()
{
   ...
   std::cout << "The first matrix is" << endl;
   std::cout << a[0][0] << ' ' << a[0][1] << endl;
   std::cout << a[1][0] << ' ' << a[1][1] << endl;

   std::cout << "The second matrix is" << endl;
   std::cout << b[0][0] << ' ' << b[0][1] << endl;
   std::cout << b[1][0] << ' ' << b[1][1] << endl;

   fastSquareMatrixMultiply(a,b,c,2);

   std::cout << "Their product is" << endl;
   std::cout << c[0][0] << ' ' << c[0][1] << endl;
   std::cout << c[1][0] << ' ' << c[1][1] << endl;
