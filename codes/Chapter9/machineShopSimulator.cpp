...
{// Input machine shop data.
   ...
   std::cout << "Enter number of machines and jobs" << endl;
   ...
   std::cout << "Enter change-over times for machines" << endl;
   int ct;
   ...
   {
      std::cout << "Enter number of tasks for job " << i << endl;
      std::cin >> numTasks;
...
{// Output wait times at machines.
   std::cout << "Finish time = " << timeNow << endl;
   for (int p = 1; p <= numMachines; p++)
   {
