...
int main()
{
   ...
   // best-case test
   std::cout << "Best-case times in progress" << endl;
   int n = 50000;
   ...
   std::cout << n << " inserts took " << elapsedTime << " ms" << endl;
   ...
   // average-case test
   std::cout << "Average-case times in progress" << endl;
   ...
   std::cout << m << " randoms took " << elapsedTime << " ms" << endl;
...
// random inserts, worst-case deletes
   std::cout << "Random inserts, worst-case deletes" << endl;
   delete s;
   s = new listType();
   ...
   // worst-case test
   std::cout << "Worst-case times in progress" << endl;
   delete s;
   s = new listType();
