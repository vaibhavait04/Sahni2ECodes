...
{// Determine whether the switch box is routable.
 ...
 // n is number of pins.
   ...
   if (s->empty())
   {// no nets remain
       std::cout << "Switch box is routable" << endl;
       return true;
    }

   std::cout << "Switch box is not routable" << endl;
   return false;
}
...
int main()
{
   ...
   std::cout << "Type number of pins in switch box" << endl;
   int n;
   std::cin >> n;
   ...
   std::cout << "Type net numbers for pins 1 through "  << n << endl;
   for (int i = 0; i < n; i++)
      std::cin >> net[i];
