...
int main()
{
   ...
   rSum(a,0);
   std::cout << "For rSum(a,0) the step count is " << stepCount << endl;
   stepCount = 0;
   rSum(a,1);
   std::cout << "For rSum(a,1) the step count is " << stepCount << endl;
   stepCount = 0;
   rSum(a,6);
   std::cout << "For rSum(a,6) the step count is " << stepCount << endl;
   return 0;
}
