...
int main()
{
   ...
   std::cout << "4 is at position " << sequentialSearch(a, 7, 4) << endl;
   std::cout << "0 is at position " << sequentialSearch(a, 7, 0) << endl;
   std::cout << "1 is at position " << sequentialSearch(a, 7, 1) << endl;
   std::cout << "8 is at position " << sequentialSearch(a, 7, 8) << endl;
   return 0;
}
